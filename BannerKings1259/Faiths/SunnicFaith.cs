...
{
    internal class SunnicFaith: MonotheisticFaith
    {
        ...
        {
            return new Banner("11.28.19.1836.1836.768.788.1.0.-30.427.2.126.440.404.680.764.0.1.-90.516.2.119.246.245.924.764.0.1.-90");
        }
        ...
        {
            return new TextObject("Sunii Islam", null);
        }
        ...
        {
            return Helpers.Helpers.IsCultureSunni(culture);
        }
