...
namespace BannerKings1259.Faiths
{
    internal class ArmenianCatholicFaith : MonotheisticFaith
    {
        ...
        {
            return new Banner("11.133.19.1836.1836.768.788.1.0.-30.510.7.0.382.470.764.634.0.1.0.510.7.0.600.470.764.748.0.1.-90");
        }
        ...
        {
            return new TextObject("Armenian Catholicism", null);
        }

        public override string GetId()
        {
            return "armenian_catholicism";
        }
        ...
        {
            return culture.StringId == "armenia";
        }
