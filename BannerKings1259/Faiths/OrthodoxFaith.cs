...
{
    internal class OrthodoxFaith : MonotheisticFaith
    {
        ...
        {
            return new Banner("11.116.19.1836.1836.768.788.1.0.-30.510.0.0.382.470.764.634.0.1.0.510.0.0.600.470.764.748.0.1.-90.510.0.0.220.360.763.549.0.1.0.510.0.0.220.360.764.893.0.1.-20");
        }
        ...
        {
            return new TextObject("Eastern Orthodoxy", null);
        }

        public override string GetId()
        {
            return "eastern_orthodox";
        }
        ...
        {
            return Helpers.Helpers.IsCultureOrthodox(culture);
        }

        public override bool IsHeroNaturalFaith(Hero hero)
        {
            if (hero.Occupation == Occupation.Lord) return this.IsCultureNaturalFaith(hero.Culture);
            if (this.IsCultureNaturalFaith(hero.Culture))
            {
