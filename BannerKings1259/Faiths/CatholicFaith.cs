...
{
    public class CatholicFaith: MonotheisticFaith
    {
        ...
        {
            return new Banner("11.27.19.1836.1836.768.788.1.0.-30.510.1.0.382.470.764.634.0.1.0.510.1.0.600.470.764.748.0.1.-90");
        }
        ...
        {
            return new TextObject("Catholicism", null);
        }
        ...
        {
            return Helpers.Helpers.IsCultureCatholic(culture);
        }
        ...
        public override bool IsHeroNaturalFaith(Hero hero)
        {
            ...
            {
                return MBRandom.RandomFloat > 0.2f;
            }
            return false;
        }
    }
