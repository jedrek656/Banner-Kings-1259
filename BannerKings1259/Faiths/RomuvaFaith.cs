...
{
    internal class RomuvaFaith: PolytheisticFaith
    {
        ...
        {
            return new Banner("11.116.19.1836.1836.768.788.1.0.-30.204.116.126.540.540.764.764.1.0.0");
        }
        ...
        {
            return new TextObject("Romuva", null);
        }
        ...
        {
            return culture.StringId == "baltic";
        }
