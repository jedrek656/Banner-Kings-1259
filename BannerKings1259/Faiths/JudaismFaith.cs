...
{
    internal class JudaismFaith : MonotheisticFaith
    {
        ...
        {
            return new Banner("11.40.19.1836.1836.768.788.1.0.-30.501.119.119.440.600.764.714.1.1.-1.501.119.119.440.600.764.814.1.1.-181");
        }
        ...
        {
            return new TextObject("Judaism", null);
        }
