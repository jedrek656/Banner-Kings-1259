...
{
    internal class ShiaFaith: MonotheisticFaith
    {
        ...
        {
            return new Banner("11.27.19.1836.1836.768.788.1.0.-30.427.14.126.440.404.764.851.0.1.-1.516.14.126.229.211.764.664.0.1.-1");
        }
        ...
        {
            return new TextObject("Shia Islam", null);
        }
        ...
        {
            return culture.StringId == "nizari";
        }
