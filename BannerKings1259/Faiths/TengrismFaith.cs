...
{
    internal class TengrismFaith: HenotheisticFaith
    {
        ...
        {
            return new Banner("11.16.19.1836.1836.768.788.1.0.-30.101611.116.126.440.440.764.764.0.1.0");
        }
        ...
        {
            return new TextObject("Tengrism", null);
        }
