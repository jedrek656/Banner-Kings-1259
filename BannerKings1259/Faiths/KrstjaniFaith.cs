...
{
    internal class KrstjaniFaith: MonotheisticFaith
    {
        ...
        {
            return new Banner("11.146.19.1836.1836.768.788.1.0.-30.419.31.143.450.450.764.764.0.0.-1");
        }
        ...
        {
            return new TextObject("Krstjani", null);
        }
        ...
        {
            return culture.StringId == "bosnia";
        }
